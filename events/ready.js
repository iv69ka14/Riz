...
module.exports = {
    ...
    execute(client) {
        ...
        const activities = [
            { name: 'You Server', type: ActivityType.Watching },
            { name: 'With Your Dreams', type: ActivityType.Playing },
            { name: 'World', type: ActivityType.Streaming },
            { name: 'Your Heartbeat', type: ActivityType.Listening },
        ];
